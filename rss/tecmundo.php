...
$description = $rss->addChild('description','RSS filtrada do Tecmundo'); //feed description
$link = $rss->addChild('link','http://sistema.combovideos.com.br/rss/tecmundo.php'); //feed site
...
$results = $mysqli->query("SELECT id, title, link, destaque, data_item, arquivo_imagem  FROM rss_tecmundo where exibir = 1");
