...
$description = $rss->addChild('description','RSS filtrada do Voxel'); //feed description
$link = $rss->addChild('link','http://sistema.combovideos.com.br/rss/voxel.php'); //feed site
...
$results = $mysqli->query("SELECT id, title, link, destaque, data_item, arquivo_imagem  FROM rss_voxel where exibir = 1");
