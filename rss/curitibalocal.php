...
$description = $rss->addChild('description','RSS filtrada do Curitiba Cult'); //feed description
$link = $rss->addChild('link','http://sistema.combovideos.com.br/rss/curitibalocal.php'); //feed site
...
$results = $mysqli->query("SELECT id, title, link, destaque, data_item, arquivo_imagem  FROM rss_curitibalocal where exibir = 1");
