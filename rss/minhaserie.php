...
$description = $rss->addChild('description','RSS filtrada do Minha Série'); //feed description
$link = $rss->addChild('link','http://sistema.combovideos.com.br/rss/minhaserie.php'); //feed site
...
$results = $mysqli->query("SELECT id, title, link, destaque, data_item, arquivo_imagem  FROM rss_minhaserie where exibir = 1");
