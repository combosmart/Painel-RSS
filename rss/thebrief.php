...
$description = $rss->addChild('description','RSS filtrada do TheBrief'); //feed description
$link = $rss->addChild('link','http://sistema.combovideos.com.br/rss/thebrief.php'); //feed site
...
$results = $mysqli->query("SELECT id, title, link, destaque, data_item, arquivo_imagem  FROM rss_thebrief where exibir = 1");
