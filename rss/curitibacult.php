...
$link = $rss->addChild('link','http://sistema.combovideos.com.br/rss/curitibacult.php'); //feed site
...
$results = $mysqli->query("SELECT id, title, link, destaque, data_item, arquivo_imagem  FROM rss_curitibacult where exibir = 1");
