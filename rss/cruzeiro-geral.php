...
$link = $rss->addChild('link','http://sistema.combovideos.com.br/rss/cruzeiro-geral.php'); //feed site
...
$results = $mysqli->query("SELECT id, title, link, destaque, data_item, arquivo_imagem  FROM rss_cruzeiro_geral where exibir = 1");
