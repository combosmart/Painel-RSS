...
$description = $rss->addChild('description','RSS filtrada do Megacurioso'); //feed description
$link = $rss->addChild('link','http://sistema.combovideos.com.br/rss/megacurioso.php'); //feed site
...
$results = $mysqli->query("SELECT id, title, link, destaque, data_item, arquivo_imagem  FROM rss_megacurioso where exibir = 1");
